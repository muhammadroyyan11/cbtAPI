				...
				<div class="row" >
					...
					<div class="col-md-10" >
						<div class="panel panel-default col-md-8">
							...
							<textarea id="contents" name="editor1" style="width: 100%;height:300px;"><?php echo preg_replace('/(<p.+?)style=".+?"(>.+?)/i', "$1$2",str_replace("\ ","\\",strip_tags($contents,"<img><table><tr><td><th><tbody><b><i><p><br><sub><sup><ins><small><del><mark><em><strong><form><input><textarea><label><caption><ul><ol><li>"))); ?></textarea>
							...
							<p>
							<input type="submit" value="Clean HTML" name="submitsave" formaction="../tls/view88.php" class="btn btn-primary btn-sm mr15">

								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<ol class="plr15">
											...
											<li>Tidak menekan tombol <button class="tombol4b">Clear</button> sebelum  nilai hasil ujian diumumkan.</li>												
											<li>Tombol <button class="tombol4c">Kirim</button> hanya digunakan jika diminta oleh Admin untuk mengirimkan ulang hasil jawaban.</li>
											<li>Tidak diperkenankan berpindah <i>browser</i> atau <i>device</i> selama ujian berlangsung tanpa seijin Admin.
											</ol>
										...
										<div class="col-md-12" >
											...
											<table width="100%" class="table-new" border="0" cellspacing="0" cellpadding="5">
												<tr class="tr-head">			
													...
													<td width="24%" align="center" class="line2">Nama Ujian</td>
													<td width="9%" align="center" class="line2">Jumlah Soal</td>
													...
													<td width="7%" align="center" class="line2">Kirim Ulang</td>
													<td width="9%" align="center" class="line2">Status</td>
												</tr>
													...
													<tr>
														...
														<td align="center" class="line"> 				
															<?php
																...
																{ ?>
																<form id="kirim" action="<?php echo site_url('kirun');?>" method="POST">
																	<input type="hidden" name="kunc" value="<?php echo $no_copy; ?>">
																	<?php	 if (isset($_COOKIE["jwbc".$no_copy])) { ?>
																		<input type="hidden" name="kujwb" value="<?php echo $_COOKIE["jwbc".$no_copy]; ?>">
																		<input class="tombol4c" type="submit" value="Kirim"/>
																	<?php } else { } ?>
																...
																{																	
																	...
																	else
																	{
																		...
																		<form id="kirim" action="<?php echo site_url('simpanjawaban');?>" method="POST" onsubmit="return validateForm<?php echo $j;?>()">
																			...
																			<input type="hidden" name="idf" value="<?php echo $list->id_folder; ?>">
																			<?php
																			...
																			<input type="hidden" name="jr" value="<?php echo $list->jr; ?>">
																			<input type="hidden" name="tw" value="<?php echo $list->tombolwaktu; ?>">
																			<input type="hidden" name="tb" value="<?php echo $list->tombol; ?>">
																			<input type="hidden" name="hs" value="<?php echo $list->hasil; ?>">
																			<input type="hidden" name="ct" value="<?php echo $list->catatan; ?>">
																			<input type="hidden" name="wt" value="<?php echo $list->waktu; ?>">
																			<input type="hidden" name="ju" value="<?php echo $list->jam_ujian; ?>">
																			<?php 
																				$noso = explode(',',$list->nosoal);
																			?>
																			
																			<input type="hidden" name="nosoal" value="<?php echo implode(',',$noso); ?>">

			...
			<div class="row" style="padding:0px 0 0px 0;">
				...
				<div class="col-md-6 text-center">	
					...
					<div style="background:#fff;max-width:450px;padding:30px;border-radius:5px;margin-left:auto;margin-right:auto;background:#fff;max-width:450px;padding:30px;border-radius:5px;margin-left:auto;margin-right:auto;-webkit-box-shadow: 3px 3px 8px 0px rgba(0,0,0,0.58); box-shadow: 3px 3px 8px 0px rgba(0,0,0,0.58);">
						...
						<span style="font-family: 'Montserrat Bold', arial;font-size:18px;font-weight:bold;">Buat Akun</span>
						<div class="garis2"></div>
						
						<center><?php echo $this->session->flashdata('pesan2');?></center>
						
						<form action="<?php echo site_url('kirim');?>" method="POST">
							<div class="form-group">
								<div class="input-group">
									<div class="input-group-addon ip">
										<i class="fa fa-user" aria-hidden="true" style="color:#c1c1c1;width:16px;"></i>
									</div>
									<input type="text"  class="form-control ip" name="nama" placeholder="Nama Lengkap" required>
								</div></div>
								<div class="form-group">
								<div class="input-group">
									<div class="input-group-addon ip">
									...
									<input type="text"  class="form-control ip" name="username" placeholder="Username" required>
								</div></div>
								<div class="form-group">
									<div class="input-group">
										<div class="input-group-addon ip">
											<i class="fa fa-envelope" aria-hidden="true" style="color:#c1c1c1;width:16px;"></i>
										</div>
										<input type="text" class="form-control ip" name="email" placeholder="Alamat Email" required>
									</div></div>
									
									<div class="form-group">
										<div class="input-group">
											<div class="input-group-addon ip">
												<i class="fa fa-lock" aria-hidden="true" style="color:#c1c1c1;width:16px;"></i>
											</div>
											<input type="password" id="pw" class="form-control ip" name="password" placeholder="Password" required>
										...
										<input class="btn" type="submit" style="font-family:'Montserrat Bold', arial;font-weight:bold;background:#f7a71e;color:#fff;width:100%; text-transform: none;" value="Buat Akun"></input>

		...
		*/
		...
		{ 
			...
			<?php 
				...
				$waktu = $this->session->userdata('tw'.$idu);
				
				$tblm = $this->session->userdata('tb'.$idu);
			?>
								...
								<tr>
									<td style="padding-top:10px;width:5%;">
										...
										<td style="padding-top:10px;width:width:5%;padding-left:10px;">
											<span id="beres">
												<form id="kirim" action="<?php echo site_url('selesai_e');?>" method="POST">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body text-left">
										<table>
											...
											<tr><td style="width:130px;"><strong>Catatan</td><td width="20px">:</strong></td><td><?php echo $this->session->userdata('ct'.$idu); ?></td></tr>
										</table>	
									</div></div></div>
						...
						<div class="row" >
							<div class="col-md-2" >
								<?php 			
									...
									$w = $this->session->userdata('wt'.$idu);
									$tgl_now = date('M d, Y');
													...
													<?php
														...
														
														{
															...
															<?php 
																...
																echo 'Jawaban Anda :<br/><textarea style="background:#fff;border:1px solid #ccc;width:100%;height:100px;padding:5px;color:#535353" id="e'.$i.'" name="ja['.$i.']" onchange="clickes1(this);">'.$jsw.'</textarea>';
			...
			<script language="javascript">				
				...
				function clickes(item) {
					...
					jawaban = document.querySelector('textarea[name="ja['+x+']"]:checked').value;	
				...
				function clickes1(item) {
					...
					var newStr = document.querySelector('textarea[name="ja['+x+']"]').value;	
